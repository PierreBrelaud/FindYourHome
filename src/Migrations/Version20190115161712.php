 ...
 */
final class Version20190115161712 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE accomodation_equipment DROP FOREIGN KEY FK_A504BDE7FD70509C');
        ...
        $this->addSql('ALTER TABLE accomodation_equipment DROP FOREIGN KEY FK_A504BDE7517FE9FE');
